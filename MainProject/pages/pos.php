    ...
    echo '</pre>';
                ...
                <div class="col-lg-12">
                  ...
                  <div class="card-header py-2">
                    <h4 class="m-1 text-lg text-primary">Categories</h4>
                  </div>
                        <!-- /.panel-heading -->
                        <div class="card-body">
                            <!-- Nav tabs -->
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#Books" data-target="#Books" data-toggle="tab">Books</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#Appliances" data-target="#Appliances" data-toggle="tab">Appliances</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#Mobiles" data-target="#Mobiles" data-toggle="tab">Mobiles</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#Fashion" data-target="#Fashion" data-toggle="tab">Fashion</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#Healthcare" data-target="#Healthcare" data-toggle="tab">Healthcare</a>
                              </li>
